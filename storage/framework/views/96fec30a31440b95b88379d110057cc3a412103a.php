<article>
    ...
    <button  type="submit" id="btnstar" aria-label="Favourite" <?php if($favoritos ===true): ?> class="liked" <?php endif; ?>>
...
<?php endif; ?>
  ...
  <hr>
<?php /**PATH C:\xampp\htdocs\miniblog\resources\views/partials/conteudo-posts.blade.php ENDPATH**/ ?>