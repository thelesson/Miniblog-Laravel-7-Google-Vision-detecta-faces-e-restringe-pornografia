<head>
  ...
  <head>
    ...
    <!-- Scripts -->
    <!-- Habilitar se der merda <script src="{{ asset('js/app.js') }}" defer></script> -->
    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0" href="{{ asset('autenticado/frontend/styles/shards-dashboards.1.1.0.min.css') }}">
    <link rel="stylesheet" href="{{ asset('autenticado/frontend/styles/extras.1.1.0.min.css') }}">
