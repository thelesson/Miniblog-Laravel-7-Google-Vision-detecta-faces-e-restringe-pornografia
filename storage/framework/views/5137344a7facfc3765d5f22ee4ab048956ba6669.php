...
<?php echo $__env->make('partials.autenticado.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   ...
   <?php echo $__env->make('partials.autenticado.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <?php echo $__env->make('partials.autenticado.add-post', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   ...
   <?php endif; ?>
    ...
    <script src="<?php echo e(asset('autenticado/frontend/scripts/app/app-blog-new-post.1.1.0.js')); ?>"></script>
...
pond.on('error',  (file, status) => {
  ...
  var usersImage = <?php echo json_encode($usersImage, JSON_HEX_TAG); ?>; 
    if (file.code >= 500) {
...
<script>
  ...
  $(document).ready(function () {
    //categorias ver mais e menos
    $(".ativado").hide();
    $("#btnVer").on("click", function () {
        var txt = $(".ativado").is(':visible') ? '--------- Ver  mais categorias ---------- ' : '--------- Ver  menos Categorias ---------- ';
        $("#btnVer").text(txt);
        $('.ativado').toggle(200);
    });
    //end
...
<?php /**PATH C:\xampp\htdocs\miniblog\resources\views/add-post.blade.php ENDPATH**/ ?>