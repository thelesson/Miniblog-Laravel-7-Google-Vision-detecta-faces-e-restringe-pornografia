...
(function ($) {
  $(document).ready(function () {
    var usuarios30dias = <?php echo e(json_encode($dxUsersPorDia,TRUE)); ?>;
    var dispositivo = <?php echo e(json_encode($dispositivo,TRUE)); ?>;
    var usuariosTotaiss = <?php echo e(json_encode($newArr,TRUE)); ?>; 
   ...
   // 
    // Datasets
    var sites = <?php echo json_encode($postsTotais); ?>;
    ...
    var bouData = {
      ...
      datasets: [{
        label: 'Usuarios cadastrados por dia nos ultimos 30 dias',
        fill: 'start',
        data: usuarios30dias,
        ...
        label: 'Total de Usuários nos ultimos 30 dias ',
        fill: 'start',
        data: usuariosTotaiss,
        backgroundColor: 'rgba(255,65,105,0.1)',
...
</script><?php /**PATH C:\xampp\htdocs\miniblog\resources\views/partials/autenticado/gambijavascript.blade.php ENDPATH**/ ?>