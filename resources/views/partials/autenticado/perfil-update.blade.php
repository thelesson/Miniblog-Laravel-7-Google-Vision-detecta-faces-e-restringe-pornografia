 ...
 <div class="row">
                ...
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                      <img class="rounded-circle" src="{{ Voyager::image( $usuario->avatar) }}" alt="User Avatar" width="110" height="110" style="   width: 150px;
    height: 150px;
    ...
    border-radius: 50%;"> </div>
                    ...
                    <span class="text-muted d-block mb-2">Membro  {{$usuario->created_at->diffForHumans()}}</span>
...
@endif
                        <form class="add-new-post" id="quill-formX" method="post" action="{{ route('updatePerfil', $usuario->id) }}">

@method('PATCH')
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="feFirstName">Nome</label>
                                <input type="text" class="form-control" id="feFirstName" name="nome" placeholder="First Name" value="{{$usuario->name}}"> </div>
                                {{ csrf_field() }}
                            </div>
                            <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" id="feEmailAddress" name="email" placeholder="Email" value="{{$usuario->email}}"> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">Password</label>
                                <input type="password" class="form-control" id="fePassword" name="senha" placeholder="deixe em branco para não alterar" > </div>
                              <input type="hidden" id="tk0" name="tk0" value="{{ \Crypt::encrypt('senha') }}">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      @php 
        ...
        @if($googleVisionCheck->value ==="SIM" && $googleVisionCheck2->value ==="SIM")
      ...
      <p><b>Status:</b> <span style="color:red;">Upload negado por conter nudez/sexo explicito e/ou ausência de rosto humano </span></p>
        ...
        @endif
        @if($googleVisionCheck->value ==="SIM" && $googleVisionCheck2->value ==="NAO")
      ...
      <p><b>Status:</b> <span style="color:red;">Upload negado por ausência de rosto humano </span></p>
        ...
        @endif
        @if($googleVisionCheck->value ==="NAO" && $googleVisionCheck2->value ==="SIM")
      ...
      <p><b>Status:</b> <span style="color:red;">Upload negado por conter nudez/sexo explicito </span></p>
        ...
        @endif
        @if($googleVisionCheck->value ==="NAO" && $googleVisionCheck2->value ==="NAO")
