            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('voyager::post.subtitle') }}
                                <span class="panel-desc"> {{ __('voyager::post.subtitle_sub') }}</span>
                            </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="{{ __('voyager::generic.subtitle') }}" value="{{ $dataTypeContent->subtitle ?? '' }}">
                        </div>
                        <!--END HACK-->
                    </div>
