                  ...
                  <div class='card-body p-0'>
                    ...
                    <li class="list-group-item p-3">
                        <span class="d-flex mb-2">
                          ...
                          <strong class="mr-1">Status:</strong> <span id="status-publicacao"><?php if(isset($postEdit)): ?> <?php if($postEdit->status ==="PUBLISHED"): ?> Publicado <?php elseif($postEdit->status ==="PENDING"): ?> Pendente <?php elseif($postEdit->status ==="DRAFT"): ?> Rejeitado <?php else: ?> Publicado <?php endif; ?> <?php else: ?> Pendente <?php endif; ?></span>
...
</div><?php /**PATH C:\xampp\htdocs\miniblog\resources\views/partials/autenticado/add-post-partials/acoesUsuarios.blade.php ENDPATH**/ ?>