 ...
 <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="/home" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="<?php echo e(asset('autenticado/frontend/images/shards-dashboards-logo.svg')); ?>" alt="Shards Dashboard">
                  <?php
              $v = App\Role::where('id',auth()->user()->role_id)->first();
              ?>
        <?php if(!empty($v)): ?>
            <?php if($v->name !=="user"): ?>
            <span class="d-none d-md-inline ml-1"><?php if(!empty($tituloDashboard->value)): ?> <?php echo e($tituloDashboard->value); ?> <?php else: ?> Admin Dashboard <?php endif; ?></span>
            <?php else: ?>
        ...
        <?php if(!empty($verificaUsuarioLog)): ?>
            <?php if($verificaUsuarioLog->name !=="user"): ?>
            <li class="nav-item">
            ...
            <?php endif; ?>
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(route('listaFavoritos')); ?>">
                  <i class="material-icons">error</i>
                  <span>Favoritos</span>
                </a>
              </li>
              <?php if(!empty($verificaUsuarioLog)): ?>
              <?php $pode = \App\Settings::where('key','site.moderadores-contatos')->first();?>
              <?php if($pode): ?>
           ...
           <!--    <li class="nav-item">
                <a class="nav-link " href="<?php echo e(route('errosSistema')); ?>">
                  <i class="material-icons">error</i>
        ...
        <!-- End Main Sidebar -->
<?php /**PATH C:\xampp\htdocs\miniblog\resources\views/partials/autenticado/sidebar.blade.php ENDPATH**/ ?>