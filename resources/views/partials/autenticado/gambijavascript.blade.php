...
(function ($) {
  $(document).ready(function () {
    var usuarios30dias = {{ json_encode($dxUsersPorDia,TRUE)}};
    var dispositivo = {{ json_encode($dispositivo,TRUE)}};
    var usuariosTotaiss = {{ json_encode($newArr,TRUE)}}; 
   ...
   // 
    // Datasets
    var sites = {!! json_encode($postsTotais) !!};
